...
exports.signup =(req ,res) => {
  ...
  exports.login= (req ,res) => {
    ...
    exports.addUserDetails = (req, res) =>{
      ...
      .update(userDetails)
      .then(() =>{
       return res.json({message : 'Details addedd Sucessfully'});
      })
      .catch((err)=>{
        console.error(err);
    ...
    .then((doc) =>{
      if(doc.exists){
        ...
        return db
        .collection('likes')
        .where('userHanlde', '==' ,req.user.handle)
        .get()
      }
    })
      .then((data)=>{
    ...
    busboy.on('file', (fieldname, file, filename, encoding, mimetype)=>{
     ...
     //433243y34.png
     imageFileName = "FM" + Math.round(Math.random()*100000000).toString()+'.'+ imageExtention;
  ...
  exports.markNofiticationsRead = (req,res)=>{
   let batch = db.batch();
